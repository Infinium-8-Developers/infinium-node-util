...
namespace currency
{
  ...
  inline core_runtime_config get_default_core_runtime_config()
  {
    ...
    pc.hard_fork_01_starts_after_height = INF_HARDFORK_01_AFTER_HEIGHT;
    pc.hard_fork_02_starts_after_height = INF_HARDFORK_02_AFTER_HEIGHT;
    pc.hard_fork_03_starts_after_height = INF_HARDFORK_03_AFTER_HEIGHT;
