...
#define CURRENCY_PUBLIC_ADDRESS_BASE58_PREFIX           0x102a79   // addresses start with 'inf'
#define CURRENCY_PUBLIC_INTEG_ADDRESS_BASE58_PREFIX     0x24ea79 // integrated addresses start with 'infi'
#define CURRENCY_PUBLIC_INTEG_ADDRESS_V2_BASE58_PREFIX  0x4c824ea79 // integrated addresses start with 'infiv2' (new format)
#define CURRENCY_PUBLIC_AUDITABLE_ADDRESS_BASE58_PREFIX 0x2a2a79 // auditable addresses start with 'inft'
#define CURRENCY_PUBLIC_AUDITABLE_INTEG_ADDRESS_BASE58_PREFIX 0x1704ea79 // auditable integrated addresses start with 'infit'
...
#define CURRENCY_NAME_ABR                               "INF"
#define CURRENCY_NAME_BASE                              "Infinium"
#define CURRENCY_NAME_SHORT_BASE                        "Infinium"
#ifndef TESTNET
